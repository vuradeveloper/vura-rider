      ...
      <div className="px-5 mt-5 space-y-2">
        {trips.map((t, i) => (
          <button key={i} className="w-full flex items-center gap-3 rounded-2xl bg-surface border border-border p-3.5 text-left hover:border-primary/40 transition">
            <span className="grid place-items-center h-12 w-12 rounded-full bg-secondary border border-transparent transition-colors focus-within:bg-background focus-within:border-primary focus:bg-background focus:border-primary text-foreground">
